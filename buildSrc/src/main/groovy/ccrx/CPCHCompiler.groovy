...
public class CPCHCompiler extends CcrxNativeCompiler<CPCHCompileSpec> {
    ...
    private static class CPCHCompileArgsTransformer extends CcrxCompilerArgsTransformer<CPCHCompileSpec> {
        @Override
