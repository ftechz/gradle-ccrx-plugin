...
class CppCompiler extends CcrxNativeCompiler<CppCompileSpec>  {
    ...
    private static class CppCompileArgsTransformer extends CcrxCompilerArgsTransformer<CppCompileSpec> {
        @Override
