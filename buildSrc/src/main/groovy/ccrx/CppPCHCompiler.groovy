...
public class CppPCHCompiler extends CcrxNativeCompiler<CppPCHCompileSpec> {
    ...
    private static class CppPCHCompileArgsTransformer extends CcrxCompilerArgsTransformer<CppPCHCompileSpec> {
        @Override
